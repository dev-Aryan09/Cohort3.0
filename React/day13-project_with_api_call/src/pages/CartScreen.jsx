  ...
  return (
    <div className="min-h-screen bg-slate-100 py-10 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* .some() returns true if atleast one item will meets the condition */}
        {cartItems.some((item) => item.quantity > 0) ? (
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 h-fit sticky top-24">
              ...
              <button className="w-full mt-6 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg font-semibold cursor-pointer">
                Checkout
              </button>
            </div>
          </div>
